...
public class GravityBootsPlayer : ModPlayer
{
                ...
                if (Player.controlJump)
                {
                    ...
                    if (gravityBootsCharge == 10)
                    {
                        for (int i = 0; i < 2; i++)
                        {
                            ...
                            Dust dust = Dust.NewDustDirect(position - new Vector2(4f, 4f), 0, 0, DustID.CrystalPulse2, 0f, 0f, 0, default, 1f);
    ...
    public override void DrawEffects(PlayerDrawSet drawInfo, ref float r, ref float g, ref float b, ref float a, ref bool fullBright)
    {
        ...
        {
            Texture2D texture = Mod.Assets.Request<Texture2D>("Content/Items/Accessories/Movement/Boots/GravityBoots_Propulsion").Value;
