...
public class StrawmanDummy : ModNPC
{
    ...
    public override void AI()
    {
        ...
        if (die)
        {
            ...
            for (int k = 0; k < 1; k++)
            {
                int goreIndex = Gore.NewGore(NPC.GetSource_Death(), new Vector2(NPC.position.X + NPC.width / 2 - 24f, NPC.position.Y + NPC.height / 2 - 4f), default, Main.rand.Next(61, 64), 1f);
                ...
                goreIndex = Gore.NewGore(NPC.GetSource_Death(), new Vector2(NPC.position.X + NPC.width / 2 - 24f, NPC.position.Y + NPC.height / 2 - 4f), default, Main.rand.Next(61, 64), 1f);
                Main.gore[goreIndex].velocity.X = Main.gore[goreIndex].velocity.X - 1f;
                Main.gore[goreIndex].velocity.Y = Main.gore[goreIndex].velocity.Y + 1f;
                goreIndex = Gore.NewGore(NPC.GetSource_Death(), new Vector2(NPC.position.X + NPC.width / 2 - 24f, NPC.position.Y + NPC.height / 2 - 4f), default, Main.rand.Next(61, 64), 1f);
                Main.gore[goreIndex].velocity.X = Main.gore[goreIndex].velocity.X + 1f;
