...
public abstract class Deathray(float maxTime, float transparency = 0f, float hitboxModifier = 1f, int drawDistance = 2400, Deathray.TextureSheeting sheeting = Deathray.TextureSheeting.Horizontal) : ModProjectile
{
    protected float maxTime = maxTime;
    protected readonly float transparency = transparency;
    protected readonly float hitboxModifier = hitboxModifier;
    protected readonly TextureSheeting sheeting = sheeting;
    protected readonly int drawDistance = drawDistance;
