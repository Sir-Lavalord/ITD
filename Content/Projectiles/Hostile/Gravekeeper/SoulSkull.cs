...
public class SoulSkull : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        {
            Dust dust = Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(16f, 16f), DustID.DungeonSpirit, new Vector2?(Main.rand.NextVector2Circular(3f, 3f)), 0, default, 2f);
