...
public class EmberSlashOld : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.InfernoFork, 0f, 0f, 0, default, 1f);
    }
    ...
    public override void OnKill(int timeLeft)
    {
        for (int i = 0; i < 20; i++)
        {
            Dust.NewDust(Projectile.Center, 1, 1, DustID.InfernoFork, 0f, 0f, 0, default, 1.5f);
        }
