...
public class AccursedSpirit : ModProjectile
{
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        for (int j = 0; j < 8; ++j)
        {
            int dust = Dust.NewDust(Projectile.Center, 10, 1, DustID.SteampunkSteam, 0f, 0f, 0, default, 1.5f);
    ...
    public override void AI()
    {
        ...
        if (!explosion)
        {
            ...
            int dust = Dust.NewDust(Projectile.position, 30, 30, DustID.SteampunkSteam, 0f, 0f, 0, default, 1f);
