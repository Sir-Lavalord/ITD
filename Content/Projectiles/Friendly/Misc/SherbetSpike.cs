...
{
    public class SherbetSpike : ModProjectile
    {
		...
		public override bool PreDraw(ref Color lightColor)
        {
			...
			Microsoft.Xna.Framework.Rectangle rectangle11 = texture.Frame(1, 5, 0, Projectile.frame, 0, 0);
			...
			for (float i = 0f; i < 1f; i += 0.25f)
            {
				...
				Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY) + new Vector2(0f, 6f).RotatedBy(radians), new Microsoft.Xna.Framework.Rectangle?(rectangle11), new Color(255, 200, 255, 0) * Projectile.Opacity, Projectile.rotation, origin10, scale10, SpriteEffects.None, 0);
            }
