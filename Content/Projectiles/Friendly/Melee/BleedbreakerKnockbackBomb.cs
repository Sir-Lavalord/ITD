...
public class BleedbreakerKnockbackBomb : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Vector2 origin = new(texture2D13.Width / 2f, texture2D13.Height / 2f / Main.npcFrameCount[npc.type]);
        Rectangle frameRect = new(0, npc.frame.Y, texture2D13.Width, vertSize);
