...
public class CosmisumaruCut : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            int num30 = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, ModContent.DustType<CosJelDust>(), Projectile.velocity.X, Projectile.velocity.Y, 0, default, 0.5f);
