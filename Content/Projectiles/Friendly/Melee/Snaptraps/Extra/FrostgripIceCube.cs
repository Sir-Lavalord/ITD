...
namespace ITD.Content.Projectiles.Friendly.Melee.Snaptraps.Extra
{
    public class FrostgripIceCube : ModProjectile
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("ITD/Content/Projectiles/Friendly/Melee/Snaptraps/Extra/FrostgripIceCube").Value;
        ...
        public override void AI()
        {
                ...
                for (int d = 0; d < 5; d++)
                {
                    Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<IceChunkDust>(), 0f, 0f, 150, default(Color), Main.rand.NextFloat(0.5f, 1f));
                }
