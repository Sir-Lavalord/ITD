...
public class EmberSlash : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        Dust dust = Dust.NewDustPerfect(Projectile.Center + Projectile.velocity + offset, DustID.Torch, velocity * 2f, 100, default, 2f);
        dust.noGravity = true;
    }
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color color = new(255, 80, 20, 200);
        Color color2 = new(255, 255, 20, 70);
