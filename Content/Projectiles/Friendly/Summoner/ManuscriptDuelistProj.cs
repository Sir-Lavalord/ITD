...
public class ManuscriptDuelistProj : ModProjectile
{
    ...
    private readonly float lastDir;
    ...
    public static void RegisterRightClick(Player player)
    {
    ...
    private static int GetInventoryShadowTier(Item item)
    {
        ...
        return item.type switch
        {
            ...
            ItemID.LucyTheAxe => 3,
            //tier 2
            ItemID.AbigailsFlower or ItemID.MonsterLasagna or ItemID.ChesterPetItem or ItemID.FroggleBunwich => 2,
            //tier 1
            ItemID.BerniePetItem or ItemID.PigPetItem or ItemID.GlommerPetItem => 1,
            _ => 0,
        };
    }
    private static int GetEquippedShadowTier(Item item)
    {
        if (item == null || item.IsAir) return 0;
        return item.type switch
        {
            //tier 5 must be equipped to get anything
            ItemID.DontStarveShaderItem or ItemID.Eyebrella or ItemID.DeerclopsMask => 5,
            //tier 4
            ItemID.BoneHelm => 4,
            //tier 3
            ItemID.Magiluminescence or ItemID.DeerclopsPetItem => 3,
            //tier 2
            ItemID.ChesterPetItem or ItemID.GarlandHat => 2,
            //tier 1
            ItemID.BerniePetItem or ItemID.PigPetItem or ItemID.GlommerPetItem => 1,
            _ => 0,
        };
    ...
    private static int GetOnheldShadowTier(Item item)
    {
        if (item == null || item.IsAir) return 0;
        ...
        {
            //tier 4
            ItemID.HoundiusShootius => 4,
            //tier 3
            ItemID.PewMaticHorn => 3,
            //tier 1
            ItemID.HamBat or ItemID.TentacleSpike or ItemID.BatBat => 1,
            _ => 0,
        };
    }
