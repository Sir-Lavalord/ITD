...
public class ManuscriptLumberProj : ModProjectile
{
    ...
    private void TreeFoundBehavior()
    {
        ...
        else
        {
            ...
            Rectangle rect = new(tileCoords.X, tileCoords.Y, tileSize.X, tileSize.Y);
    ...
    public static Item FindAxe(Player player)
    {
        Item item = null;
        for (int i = 0; i < 50; i++)
        {
    ...
    {
        fallThrough = AI_State != ActionState.Spawn && Projectile.Bottom.Y < Main.player[Projectile.owner].Top.Y - 120f;
