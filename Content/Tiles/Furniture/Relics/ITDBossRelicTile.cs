...
namespace ITD.Content.Tiles.Furniture.Relics;
...
public abstract class ITDBossRelic : ModTile
{
    ...
    public virtual string RelicTextureName => "ITD/Content/Tiles/Relics/MinionBossRelic";

    // All relics use the same pedestal texture, this one is copied from vanilla
    public override string Texture => "ITD/Content/Tiles/Furniture/Relics/RelicPedestal";
