...
public abstract class ITDTree : ModTile
{
    ...
    {
        return Mod.Assets.Request<Texture2D>("Content/Tiles/BlueshroomGroves/BlueshroomTops").Value;
    }
    public virtual Texture2D GetBranches()
    {
        return Mod.Assets.Request<Texture2D>("Content/Tiles/BlueshroomGroves/BlueshroomBranches").Value;
    }
    /// <summary>
