...
public class ITD : Mod
{
    ...
    public static Asset<Texture2D> TrueMagicPixel => ITD.Instance.Assets.Request<Texture2D>("Content/TrueMagicPixel");
    ...
    public static void PreAssignShadersProperties()
    {
