...
public class ITDAlpha : ModMenu
{
    ...
    public override Asset<Texture2D> Logo => Mod.Assets.Request<Texture2D>("Menus/Textures/AlphaMenu");
    ...
    public override bool PreDrawLogo(SpriteBatch spriteBatch, ref Vector2 logoDrawCenter, ref float logoRotation, ref float logoScale, ref Color drawColor)
    {
        ...
        Texture2D tex = Mod.Assets.Request<Texture2D>("Menus/Textures/AlphaSnow").Value;
        for (int i = 0; i < snows.Count; i++)
        {
            ...
            spriteBatch.Draw(tex, snows[i].Position, frame, Color.White, snows[i].Velocity.ToRotation() - MathHelper.PiOver2, new Vector2(tex.Width * 0.5f, tex.Height / 3 * 0.5f), smooth, SpriteEffects.None, 0f);
        }
        ...
        // draw the logo
        Asset<Texture2D> glowmask = Mod.Assets.Request<Texture2D>("Menus/Textures/AlphaMenu_Glow");
